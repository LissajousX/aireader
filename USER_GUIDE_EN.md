...
│            │                                 │                       │
│  🅰 AiReader │       READING AREA             │  ┌─────┬────┬────┬──┐│
│            │                                 │  │Trans│Expl│Chat│Note│
│  📂 Import  │       📖 PDF / EPUB / MD / TXT   │  ├─────┴────┴────┴──┤│
│            │                                 │  │                   ││
│  📄 Paper   │                                 │  │  Select text to   ││
│  📘 Novel   │                                 │  │  auto-translate   ││
│  📝 Notes   │                                 │  │                   ││
│            │                                 │  │  Translation       ││
│            │    ◀ ▶  ➖ 100% ➕  1/42  🌓     │  │  results here      ││
│ ─────────  │    ↑ Floating Toolbar            │  ├───────────────────┤│
│ Library    │                                 │  │ 💬 Input...    ➤  ││
│ Settings   │                                 │  └───────────────────┘│
├────────────┴─────────────────────────────────┴───────────────────────┤
...
- **Sidebar** — AiReader logo (click to return to welcome), import button, document list, bottom shortcuts
